...
import { ExactEvmScheme } from "@x402/client";
...
const account = privateKeyToAccount(config.appWalletPrivateKey);
const client = new x402Client().register("eip155:42220", new ExactEvmScheme(account, { rpcUrl: config.celoRpcUrl }));
